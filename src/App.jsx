...
export default function App() {
        ...
        if (data) {
            ...
            if (keyPath.length > 0) {
                keyPath = keyPath.map((path) => {
                    ...
                    let pathVersions = Object.keys(
                        _.get(child, splitPath).versions
                    );
                    let filteredPath = splitPath
                        .filter(
                            (item) => item !== 'versions' && item !== 'child'
                        )
                        .join('/');
    ...
    const handlePathChange = (event) => {
        ...
        // Getting new description and info data for path generated
        let descriptions = [];
        let infos = [];
            ...
            <div className={classes.root}>
                ...
                {paths.length > 0 ? (
                    ...
                    <Stack
                        ...
                        isTutorialDisplay={isTutorialDisplay}
                    />
                )}
